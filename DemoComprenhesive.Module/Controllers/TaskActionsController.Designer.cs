namespace DemoComprenhesive.Module.Controllers
{
    partial class TaskActionsController
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.SetTaskAction.TargetObjectType = typeof(DemoComprenhesive.Module.BusinessObjects.DemoTask);
            this.SetTaskAction.ToolTip = null;
            this.SetTaskAction.Execute += new DevExpress.ExpressApp.Actions.SingleChoiceActionExecuteEventHandler(this.SetTaskAction_Execute_1);
            // 
