...
namespace DemoComprenhesive.Module.Controllers
{
    ...
    public partial class TaskActionsController : ViewController
    {
        ...
        private void SetTaskAction_Execute_1(object sender, SingleChoiceActionExecuteEventArgs e)
        {
            IObjectSpace objectSpace = View is DevExpress.ExpressApp.ListView ?
